                        ...
                        <div  className="card project-boxed">
                            ...
                            <div className="card-header align-items-start">
                                <div>
                                    ...
                                    <h6 className="fs-18 font-w500 mb-3"><Link to="#" className="text-black user-name">{post.title}</Link></h6>
                                    <div className="text-dark fs-14 text-nowrap">{`${post.owner.firstName} ${post.owner.lastName} . ${new Date(post.createdAt).toLocaleString('en-US', {year: 'numeric', month: 'long', day: 'numeric' })}`}</div>
                                </div>
                                <Dropdown className="">
                                    ...
                                    <Dropdown.Menu alignRight={true} className="dropdown-menu-right">
                                        ...
                                        <Dropdown.Item className="text-danger" onClick={() => handleDelete(post._id)}>Delete</Dropdown.Item>
                                    </Dropdown.Menu>
                                </Dropdown>
                            </div>
                        </div>
